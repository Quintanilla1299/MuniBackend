...
publicRouter.post('/sit/public/info-legal-regulatoria/listar', LegalInfoController.findAll)
publicRouter.post('/sit/public/zona-riesgo/listar', RiskZoneController.findAll)
publicRouter.post('/sit/public/sitio-arqueologico/listar', ArchaeologicalSiteController.findAll)
publicRouter.post('/sit/public/guia-viaje/listar', TravelDestinationController.findAll)
